 <style>
   ...
   <section>
        <div class="container">
            <div class="box">
                <div class="titel">
                    <h3> 7 tác phẩm anime được Hollywood chuyển thể live action: thành công hay thất bại?</h3>
                </div>
                <div class="muc-luc">
                     <ul>
                        <li>
                            <a href="#">0.1 - Alita: Battle Angel</a><br>
                            <a href="#">0.2 - Naruto</a><br>
                            <a href="#">0.3 - Bleach</a><br>
                            <a href="#">0.4 - Beyblade</a><br>
                            <a href="#">0.5 - One Piece</a><br>
                            <a href="#">0.6 - Your Name</a><br>
                            <a href="#">0.7 - Sword Art Online</a>
                        </li>
                     </ul>
                </div>
               <p><strong>Những thông tin mới đây nhất về dự án chuyển thể Your Name sang phiên bản live action đã khiến khán giả
                ...
                <h4>Your Name</h4>
                <p>
                   Đầu năm 2017, Your Name đã gây bão tại các rạp chiếu phim Nhật Bản và các nước trong khu vực, trở thành bộ
                   phim hoạt hình anime có doanh thu cao nhất trong lịch sử. Nối tiếp thành công đó, hãng Paramount Pictures và
                   Bad Robot Productions đã mua lại bản quyền bộ phim và lên kế hoạch chuyển thể sang phiên bản live action.
                   <br>
                   Dự án này không được Hollywood tiến hành xây dựng độc lập mà kết hợp với Toho – hãng phim phân phối bản
                   gốc Your Name cùng nhau bắt tay thực hiện. Với sự góp mặt của đạo diễn bộ phim gốc, khán giả hi vọng Your
                   Name sẽ thành công và giữ được sức hút của mình.
                </p>
                ...
                <p>
                    Sword Art Online là bộ phim anime về game thực tế ảo, đã khiến khán giả yêu thích dòng phim hoạt hình mê
                    mẩn khi lần đầu tiên ra mắt công chúng. Sau sự thành công của phần một, nhà sản xuất vẫn chưa tiếp tục thực
                    hiện phần hai của bộ phim khiến nhiều khán giả buồn bã. Tuy nhiên, đầu năm 2016 hãng Skydance Media đã
                    đưa ra thông báo họ đã mua bản quyền và tiến hành sản xuất bộ phim theo phiên bản live action. Bộ phim được
                    chắp bút bởi biên kịch của bộ phim Kẻ hủy diệt - Laeta Kalogridis.
                    <br>
                    Thông tin này đã khiến cho khán giả đứng ngồi không yên chờ ngày ra mắt phim. Nhưng từ khi đưa ra thông báo
                    cho đến nay, nhà sản xuất chưa tiết lộ thêm bất cứ thông tin nào về dự án chuyển thể này. Và tất nhiên khán giả
                    vô cùng hi vọng Sword Art Online do người đóng sẽ mang lại thành công cho thương hiệu này, tránh xa con
                    đường thất bại của những bộ phim anime đã chuyển thể trước đó.
                </p>
                </div>
           </div>
        </div>
