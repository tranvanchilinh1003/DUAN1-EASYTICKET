                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            <div class="anime__details__title">
                                <h4>THÁM TỬ LỪNG DANH CONAN: NÀNG DÂU HALLOWEEN</h4>
                            </div>
                           <!--<div class="anime__details__rating">
                            ...
                            <p> phần phim thứ 25 mang tên Nàng Dâu Halloween - bộ phim sẽ tập trung vào việc Conan phá án vào cuộc hôn lễ nguy
                                hiểm nhất thế giới xuất phát từ cơn mưa bom đạn từ đường dây khủng bố, khiến thành phố Shibuya náo nhiệt bỗng chóc
                                hỗn loạn!</p>
                            ...
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>Ngày Phát Sóng</span>   21/7/2022</li>
                                            <li><span>Thời Lượng:</span> 111 phút</li>
                                            <li><span>Tình Trạng:</span> Đang phát sóng</li>
                                            <li><span>Độ Phân Giải:</span> HD</li>
                                            <li><span>Thể Loại:</span> Hoạt Hình</li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                           <li><span>Nhà Sản Xuất</span> DreamWorks</li>
                                            <li><span>xếp hạng</span><i class="fa fa-star" style="color: orange;"></i> 8.6 (117 đánh giá)</li>
                                            <li><span>Đạo Diễn</span> gosho aoyama, susumu mitsunaka</li>
                                            <li><span> Diễn Viên</span> Minami Takayama, chafûrin, tōru furuya</li>
                            ...
                            <div class="anime__details__btn">
                                <a class="follow-btn" href="https://youtu.be/Gmkmmi7A8Ak"> TRAILER</a>
                        ...
                        <div class="anime__details__review">
                            ...
                            <div class="anime__review__item">
                                ...
                                <div class="anime__review__item__text">
                                    <h6>Chris Curry - <span>1 năm trước</span></h6>
                                    <p><i class="fa fa-star" style="color: orange;"></i> 10/10 Cực Phẩm! </p>
                                    <p>Phim rất hay và rất dễ đoán nội dung</p>
                                </div>
                            </div>
                            <div class="anime__review__item">
                                <div class="anime__review__item__pic">
                                ...
                                <div class="anime__review__item__text">
                                    ...
                                    <p><i class="fa fa-star" style="color: orange;"></i> 5/10 Tạm ổn</p>
                                    <p>hay</p>
                                </div>
                            </div>
                            <div class="anime__review__item">
                                ...
                                <div class="anime__review__item__text">
                                    ...
                                    <p><i class="fa fa-star" style="color: orange;"></i> 10/10 Cực Phẩm! </p>
                                    <p>dàn nhân vật đỉnh của chóp 💕</p>
                                </div>
                            </div>
                            <div class="anime__review__item">
                                <div class="anime__review__item__pic">
                                ...
                                <div class="anime__review__item__text">
                                    <h6>Chris Curry - <span>1 năm trước</span></h6>
                                    <p><i class="fa fa-star" style="color: orange;"></i> 8/10 Đáng Xem </p>
                                    <p>phim hay nha mn nên xem</p>
                                </div>
                            </div>
                            <div class="anime__review__item">
                                <div class="anime__review__item__pic">
                                ...
                                <div class="anime__review__item__text">
                                    <h6>Lewis Mann - <span>1 năm trước</span></h6>
                                    <p>Bộ phim này đúng là tuyệt vời 👍👍</p>
                                </div>
                            </div>
                            <div class="anime__review__item">
                                <div class="anime__review__item__pic">
                                ...
                                <div class="anime__review__item__text">
                                    <h6>Louis Tyler - <span>1 năm trước</span></h6>
                                    <p><i class="fa fa-star" style="color: orange;"></i> 10/10 Cực Phẩm! </p>
                                    <p>Hay lắm lunnnn á k xem phí lắm ạ</p>
                                </div>
                            </div>
                        </div>
