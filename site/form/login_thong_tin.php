						...
						<div class="row gutters">
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="form-group text-light">
									...
									<input type="text" class="form-control" style="background-color: #1A223A;" name="username" id="fullName" readonly value="<?= $user['username'] ?>">
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="form-group text-light">
									...
									<input type="text" class="form-control" id="information" name="information" value="<?= $user['information'] ?>">
									<span class='error text-danger'></span>
								</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="form-group text-light">
									...
									<input type="password" class="form-control" name="confirm_pass" id="confirm_pass" value="">
									<span class='error text-danger'></span>
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="form-group text-light">
									...
									<input type="password" class="form-control" id="password" name="password" placeholder='Nhập Để Đổi Mật Khẩu Hoặc Bỏ Trống'>
								</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="form-group text-light">
						...
						<div class="row gutters ">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="text-right">
									...
									<button type="submit" id="submit" name="update_user" class="btn btn-danger">Cập nhập</button>
								</div>
							</div>
						</div>
