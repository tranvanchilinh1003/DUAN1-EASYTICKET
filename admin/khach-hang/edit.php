                    ...
                    <form class="form" action="./index.php" method="post" id="isert_form" enctype="multipart/form-data">
                        <div class='row mt-2'>
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control " style="background-color: #2A3038;" id="username" name="username" readonly value="tài khoản">
                                <span class="error text-danger"></span>
                            </div>
                            <div class="col-sm-4">
                                <label for="full_name" class="fw-bold col-form-label text-white">Họ Và Tên</label>
                                <input type="text" class="form-control" id="full_name" name="full_name" value="Full Name">
                                <span class="error text-danger"></span>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class='row mt-3'>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="file" class="form-control" id="image" name="image" value="ảnh">
                                <input type="hidden" name="hinh_old" id="" value='<?= $image ?>'>
                                <span class="error text-danger"></span>
                            </div>
                            <div class="col-sm-4">
